...
# so we have four inputs here so we can iterate over four numbers using a
# while loop
...
Repeating identical or similar tasks without making errors is something that
...
# Basic For Loop
# Again sequences are a very common type of iterable. Some examples for
# built-in sequence types are lists, strings, and tuples.

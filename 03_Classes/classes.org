...
#+BEGIN_SRC ditaa :file ./img/notes.png
...
#+BEGIN_SRC ditaa :file ./img/noteToNotesRelation.png
 +--------------------------------------------------------------------------------------+
 |  cRED Notebook                                                                       |
 |  +-------+   +-------+   +--------+   +---------+    +----------+    +---------+     |
...
#+RESULTS:
[[file:./img/noteToNotesRelation.png]]


We can model our Note class as,

#+INCLUDE: "./notebook.py" :lines "0-21" src python -n

The Note class can be utilised by making instances like, 

#+INCLUDE: "./notebook.py" :lines "74-75" src python -n
...
#+INCLUDE: "./notebook.py" :lines "0-35" src python -n
...
#+INCLUDE: "./notebook.py" :lines "76-80" src python -n
...
#+INCLUDE: "./notebook.py" :lines "0-72" src python -n

To execute the program just type,

#+INCLUDE: "./notebook.py" :lines "81-" src python -n


Here is a full v2.0 updated version of this program.

#+INCLUDE: "./notebook_v2.py" :lines "0-" src python -n
